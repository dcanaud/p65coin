...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s p65coin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  p65coin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded p65coin transaction") + "\n" +
              "  p65coin-tx [options] -create [commands]   " + _("Create hex-encoded p65coin transaction") + "\n" +
              "\n";
