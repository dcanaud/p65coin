...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.p65coin.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("p65cointools.com", "dnsseed.p65cointools.com"));
        vSeeds.push_back(CDNSSeedData("p65coinpool.org", "dnsseed.p65coinpool.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("p65cointools.com", "testnet-seed.p65cointools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.p65coin.loshan.co.uk", true));
