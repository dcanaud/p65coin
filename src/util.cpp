...
const char * const BITCOIN_CONF_FILENAME = "p65coin.conf";
const char * const BITCOIN_PID_FILENAME = "p65coin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "P65Coin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/P65Coin";
#else
    // Unix
    return pathRet / ".p65coin";
#endif
#endif
}
